...
LAB26:    if (*((unsigned int *)t6) < *((unsigned int *)t9))
        goto LAB25;
...
LAB20:    xsi_set_current_line(45, ng0);
    t31 = ((char*)((ng4)));
    t32 = (t0 + 2384);
    xsi_vlogvar_wait_assign_value(t32, t31, 0, 0, 17, 0LL);
...
LAB38:    if (*((unsigned int *)t36) < *((unsigned int *)t37))
        goto LAB36;
...
LAB49:    xsi_set_current_line(54, ng0);
    t79 = ((char*)((ng3)));
    t80 = (t0 + 2384);
    xsi_vlogvar_wait_assign_value(t80, t79, 0, 0, 17, 0LL);
    ...
    t11 = (t9 + 56U);
    t24 = *((char **)t11);
    xsi_vlog_generic_convert_bit_index(t8, t7, 2, t24, 17, 2);
    t25 = (t8 + 4);
    t12 = *((unsigned int *)t25);
    t10 = (!(t12));
    if (t10 == 1)
...
LAB51:    xsi_set_current_line(56, ng0);
    ...
    t7 = (t0 + 2544);
    xsi_vlogvar_wait_assign_value(t7, t8, 0, 0, 17, 0LL);
    goto LAB48;

LAB50:    xsi_vlogvar_assign_value(t2, t3, 0, *((unsigned int *)t8), 1);
    goto LAB51;
...
LAB68:    if (*((unsigned int *)t35) < *((unsigned int *)t36))
        goto LAB67;

LAB66:    *((unsigned int *)t38) = 1;

LAB67:    memset(t42, 0, 8);
    t41 = (t38 + 4);
...
extern void work_m_08669707282494424727_4213641838_init()
{
	...
	xsi_register_didat("work_m_08669707282494424727_4213641838", "isim/uart_rx_isim_beh.exe.sim/work/m_08669707282494424727_4213641838.didat");
